          ...
          >
            ...
            <form>
              ...
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                ...
                />
                <p className="text-body-color dark:text-body-color-dark w-full px-5 text-center text-base shadow-solid-3 transition-all hover:shadow-solid-4 dark:border-strokedark dark:bg-blacksection dark:hover:bg-hoverdark rounded-[4px]">
                Si ya sos cliente, tus datos se completarán automáticamente.
              </p>
              </div>
